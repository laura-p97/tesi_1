...
%\\Dai grafici di confronto riportati in questa sezione si nota che l'analisi del BDT fornisce risultati migliori rispetto all'analisi standard di ALICE per valori bassi di $p_T$ ($p_T$ < 5 GeV/c), mentre all'aumentare del $p_T$ l'analisi standard di ALICE fornisce risultati migliori. Questo pu\`o essere spiegato principalmente considerando due fattori:
    \begin{itemize}
